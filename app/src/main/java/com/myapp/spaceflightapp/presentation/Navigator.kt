...
import com.myapp.spaceflightapp.core.PreferencesProvider
import com.myapp.spaceflightapp.core.Read
import com.myapp.spaceflightapp.core.Save
import com.myapp.spaceflightapp.presentation.apod.ApodNavigator
import com.myapp.spaceflightapp.presentation.apod.PhotoOfTheDay
import com.myapp.spaceflightapp.presentation.articles.Articles
import com.myapp.spaceflightapp.presentation.articles.ArticlesNavigator
import com.myapp.spaceflightapp.presentation.blogs.Blogs
import com.myapp.spaceflightapp.presentation.blogs.BlogsNavigator
import com.myapp.spaceflightapp.presentation.favorites.Favorites
import com.myapp.spaceflightapp.presentation.favorites.FavoritesNavigator
import com.myapp.spaceflightapp.presentation.reports.Reports
import com.myapp.spaceflightapp.presentation.reports.ReportsNavigator
